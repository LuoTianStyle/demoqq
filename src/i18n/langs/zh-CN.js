...
const zhCn = {
  ...
  'password-is-wrong': '密码输入有误，请输入5至13位的数字字母组合',
  'username-is-wrong': '账号输入有误，请输入3至30位的数字字母组合',
  'username-is-wrong1': '账号输入有误，请输入30位以内的数字字母组合',
  'login-submit': '登录',
  title: '海外代理商后台',
  'account-login': '账号登录',
  // home
  ...
  'buy-number-rule-max': '购买数量不得大于500',
  'buy-year-required': '请输入购买时长/年',
  'buy-year-rule': '购买时长/年为大于0的整数',
  'buy-year-rule-max': '购买时长/年不得大于30',
  'success-result': '支付成功！',
